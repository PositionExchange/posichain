...
```bash
export CGO_CFLAGS="-I$GOPATH/src/github.com/PositionExchange/bls/include -I$GOPATH/src/github.com/PositionExchange/mcl/include -I/usr/local/opt/openssl/include"
export CGO_LDFLAGS="-L$GOPATH/src/github.com/PositionExchange/bls/lib -L/usr/local/opt/openssl/lib"
export LD_LIBRARY_PATH=$GOPATH/src/github.com/PositionExchange/bls/lib:$GOPATH/src/github.com/PositionExchange/mcl/lib:/usr/local/opt/openssl/lib
