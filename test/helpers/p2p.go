...
func init() {
	...
	Topics = []string{
		"psc/testnet/0.0.1/client/beacon",
		"psc/testnet/0.0.1/node/beacon",
		"psc/testnet/0.0.1/node/shard/1",
		"psc/testnet/0.0.1/node/shard/2",
		"psc/testnet/0.0.1/node/shard/3",
	}
